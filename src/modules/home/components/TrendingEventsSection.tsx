...
const TrendingEventsSection = ({ events, onBookNow }: TrendingEventsSectionProps) => {
    // Sử dụng custom hook cho horizontal scroll
    const { scrollContainerRef, showLeftButton, showRightButton, scrollToDirection } =
        useHorizontalScroll({
            itemWidth: 300,
            gap: 16,
            itemsPerScroll: 3,
    ...
    const top10Events = [...events].sort((a, b) => b.viewCount - a.viewCount).slice(0, 10);
        ...
        return (
            <div className="absolute -left-1 bottom-[-10px]">
                <span
                    ...
                    "
                    style={{
                        WebkitTextStroke: "2px #92400e", // viền chữ vàng đậm
            ...
            <div className="relative">
                ...
                >
                    {top10Events.map((event, index) => (
                        <div key={event.id} className="relative mt-2 w-[350px] pl-14 h-[200px]">
