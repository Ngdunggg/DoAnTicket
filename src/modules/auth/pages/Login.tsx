...
const Login = () => {
    const { isAuthPopupOpen, openAuthPopup, closeAuthPopup } = useAuthPopup();
            ...
            <div className="flex flex-col items-center justify-center h-full">
                ...
                <div className="flex-1 flex flex-col items-center justify-center gap-6">
                    ...
                    <div className="text-center max-w-md">
                        ...
                        >
                            Nhấn nút trên để mở popup đăng nhập/đăng ký. 
                            Popup sẽ hiển thị ở giữa màn hình và có thể chuyển đổi 
                            giữa đăng nhập và đăng ký.
                        </Text>
                    </div>
                </div>
