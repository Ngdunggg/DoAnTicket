...
import WavyLineIcon, { MODE_WAVY_LINE } from "@share/components/atoms/icons/WavyLineIcon";
...
const QRPopup: React.FC<QRPopupProps> = ({ isOpen, onClose, ticket, formatDateTime }) => {
        ...
        <div className="fixed inset-0 h-screen bg-black/70 flex items-center justify-center z-50">
            <div className="bg-bg-black-2 rounded-2xl w-full max-w-[500px] border border-bg-gray">
                ...
                <div className="flex flex-col bg-bg-yellow rounded-t-2xl relative">
                    ...
                    <WavyLineIcon mode={MODE_WAVY_LINE.YELLOW} className="w-[1032px] absolute bottom-[-10px]" />
                </div>
                ...
                <div className="p-6 flex flex-col gap-6">
                    ...
                    <div className="flex justify-center">
                        <div className="bg-white p-4 rounded-xl">
                            <QRCodeSVG value={qrData} size={300} level="H" includeMargin={true} />
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col text-center">
                        ...
                        <Text modeColor={MODE_COLOR_TEXT.GRAY_SECONDARY} modeSize={MODE_SIZE[12]}>
