  ...
  return (
    <div className="flex flex-col px-6 gap-10">
      <div className="flex items-center gap-1">
        ...
        <Text
          modeColor={
            !isProfilePage ? MODE_COLOR_TEXT.YELLOW : MODE_COLOR_TEXT.WHITE
          }
          modeSize={MODE_SIZE[16]}
      ...
      <div className="flex flex-col px-14 gap-5">
        ...
        >
          <UserIcon
            mode={isProfilePage ? MODE_USER.YELLOW : MODE_USER.DEFAULT}
          />
          <Text
            modeColor={
              isProfilePage ? MODE_COLOR_TEXT.YELLOW : MODE_COLOR_TEXT.WHITE
        ...
        >
          <TicketIcon
            mode={!isProfilePage ? MODE_TICKET.YELLOW : MODE_TICKET.WHITE}
          />
          <Text
            modeColor={
              !isProfilePage ? MODE_COLOR_TEXT.YELLOW : MODE_COLOR_TEXT.WHITE
